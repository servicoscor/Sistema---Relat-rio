...
const state = {
  ...
  filterTeam: 'Todas as equipes', refDate: today(), saved: false, form: emptyForm(), editing:null,dirty:false,saving:false,authBusy:false,recordsLoading:false,recordsError:'',teams:[],defaults:null,groups:[],groupsTeam:'',groupsVersion:'',preferencesBusy:false,notice:''
};
...
function resetSession(){
  ...
  Object.assign(state,{user:null,profile:null,authPass:'',authEmail:'',authName:'',authTeam:'',
    ...
    saving:false,authBusy:false,recordsLoading:false,recordsError:'',teams:[],defaults:null,groups:[],groupsTeam:'',groupsVersion:'',preferencesBusy:false,notice:'',filterTurn:'Todos',
